package com.dhthuyloi.mxhung.dulichvietnam.google;
...
//				return super.onCreateDialog(id);
    ...
    private String getDirectionUrl(LatLng origin, LatLng dest) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/json?" + parameters + "&key=AIzaSyCgMD65ti0BBFkhMAEmHZjoQpY4_TXn7uA";
        return url;
    }
